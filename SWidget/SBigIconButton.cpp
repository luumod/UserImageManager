...
SBigIconButton::SBigIconButton(const QString& iconPath, const QString& description, int radius, QWidget* parent) :
    QWidget(parent),
    cornerRadius(radius)
{
...
void SBigIconButton::resizeEvent(QResizeEvent* event) {
...
void SBigIconButton::enterEvent(QEnterEvent* event) {
...
void SBigIconButton::leaveEvent(QEvent* event) {
    bgWidget->setStyleSheet(radiusStyle + "background-color:#04000000");
...
void SBigIconButton::mousePressEvent(QMouseEvent* event) {
...
void SBigIconButton::mouseReleaseEvent(QMouseEvent* event) {
    if (mousePressed) {
        bgWidget->setStyleSheet(radiusStyle + "background-color:#0a0078D4");
        QPropertyAnimation* longer = new QPropertyAnimation(indicator, "geometry", this);
        longer->setStartValue(indicator->geometry());
...
void SBigIconButton::setScale(qreal scale) {
